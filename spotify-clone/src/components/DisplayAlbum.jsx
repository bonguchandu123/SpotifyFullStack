...
const DisplayAlbum = ({album}) => {
  ...
  return albumData?(
    <>
      ...
      <div className="mt-10 flex gap-8 flex-col md:flex-row md:items-end">
        ...
        <div className="flex flex-col">
          ...
          <p className="mt-1">
            <img src="inline-block w-5" alt="" className={assets.spotify_logo} />
            <b>Spotify</b>
            • 1,323,154 likes
            • <b>50 songs</b>
            about 2hr 30 min
    ...
    {songsData.filter((item) =>item.album === album.name ).map((item,index) => (
      <div onClick={() => playWithId(item._id)} key ={index} className="grid grid-cols-3 sm:grid-cols-4 gap-2 p-2 items-centre text-[#a7a7a7] hover:bg-[#afafaf2b] cursor-pointer">
